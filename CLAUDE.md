...
version it speaks to. The tunnel protocol carries its own integer version, negotiated in `hello`
and independent of the release version — bump it only when the wire format changes.
